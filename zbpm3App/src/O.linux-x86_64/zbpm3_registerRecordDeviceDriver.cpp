...
/* Generated from ../O.Common/zbpm3.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devPSCRegRBF64Ai, *pvar_dset_devAoSoft,
    ...
    *pvar_dset_devPSCConnectedBi, *pvar_dset_devPSCOnConnectBi,
    *pvar_dset_devPSCRegBi, *pvar_dset_devPSCRegRBBi,
    ...
    *pvar_dset_devPSCForceReConn, *pvar_dset_devPSCRegBo,
    *pvar_dset_devPSCSingleU32Bo, *pvar_dset_devCalcoutSoft,
    *pvar_dset_devCalcoutSoftCallback, *pvar_dset_devEventSoft,
    *pvar_dset_devHistogramSoft, *pvar_dset_devI64inSoft,
    *pvar_dset_devI64inSoftCallback, *pvar_dset_devPSCRegI64i,
    *pvar_dset_devPSCRegRBI64i, *pvar_dset_devI64outSoft,
    *pvar_dset_devI64outSoftCallback, *pvar_dset_devPSCRegI64o,
    *pvar_dset_devPSCSingleS64I64o, *pvar_dset_devLiSoft,
    *pvar_dset_devLiSoftCallback, *pvar_dset_devLiGeneralTime,
    *pvar_dset_devPSCUknCountLi, *pvar_dset_devPSCConnCountLi,
    *pvar_dset_devPSCBlockCountLi, *pvar_dset_devPSCRegLi,
    *pvar_dset_devPSCRegRBLi, *pvar_dset_devLoSoft,
    ...
    *pvar_dset_devPSCRegMbbi, *pvar_dset_devPSCRegRBMbbi,
    ...
    *pvar_dset_devPSCRegRBMbbiDirect, *pvar_dset_devMbboSoft,
    ...
    *pvar_dset_devPSCBlockInWf24, *pvar_dset_devPSCBlockInWf32,
...
static const char * const deviceSupportNames[] = {
    ...
    "devPSCRegRBF32Ai", "devPSCRegRBF64Ai", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devPSCRegAo", "devPSCRegF32Ao",
    "devPSCRegF64Ao", "devPSCSingleS32Ao", "devPSCSingleF32Ao",
    "devPSCSingleF64Ao", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devPSCConnectedBi", "devPSCOnConnectBi",
    "devPSCRegBi", "devPSCRegRBBi", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState",
    "devPSCSendAllBo", "devPSCForceReConn", "devPSCRegBo",
    "devPSCSingleU32Bo", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devEventSoft", "devHistogramSoft", "devI64inSoft",
    "devI64inSoftCallback", "devPSCRegI64i", "devPSCRegRBI64i",
    "devI64outSoft", "devI64outSoftCallback", "devPSCRegI64o",
    "devPSCSingleS64I64o", "devLiSoft", "devLiSoftCallback",
    "devLiGeneralTime", "devPSCUknCountLi", "devPSCConnCountLi",
    "devPSCBlockCountLi", "devPSCRegLi", "devPSCRegRBLi", "devLoSoft",
    "devLoSoftCallback", "devPSCSendLo", "devPSCRegLo",
    "devPSCSingleS32Lo", "devLsiSoft", "devLsiEnviron", "devLsoSoft",
    "devLsoSoftCallback", "devLsoStdio", "devMbbiSoft", "devMbbiSoftRaw",
    "devMbbiSoftCallback", "devPSCRegMbbi", "devPSCRegRBMbbi",
    "devMbbiDirectSoft", "devMbbiDirectSoftRaw",
    "devMbbiDirectSoftCallback", "devPSCRegMbbiDirect",
    "devPSCRegRBMbbiDirect", "devMbboSoft", "devMbboSoftRaw",
    "devMbboSoftCallback", "devPSCRegMbbo", "devPSCSingleU32Mbbo",
    "devMbboDirectSoft", "devMbboDirectSoftRaw",
    "devMbboDirectSoftCallback", "devPSCRegMbboDirect",
    "devPSCSingleU32MbboDirect", "devPrintfSoft", "devPrintfSoftCallback",
    ...
    "devPSCBlockInWf24", "devPSCBlockInWf32", "devPSCBlockOutWf32",
    "devPSCBlockInWfF32", "devPSCBlockOutWfF32", "devPSCBlockInWfF64",
    "devPSCBlockOutWfF64"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devPSCSingleF64Ao, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    pvar_dset_devBiDbState, pvar_dset_devPSCConnectedBi,
    pvar_dset_devPSCOnConnectBi, pvar_dset_devPSCRegBi,
    pvar_dset_devPSCRegRBBi, pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_devPSCSendAllBo,
    pvar_dset_devPSCForceReConn, pvar_dset_devPSCRegBo,
    pvar_dset_devPSCSingleU32Bo, pvar_dset_devCalcoutSoft,
    ...
    pvar_dset_devPSCSingleU32Mbbo, pvar_dset_devMbboDirectSoft,
    pvar_dset_devMbboDirectSoftRaw, pvar_dset_devMbboDirectSoftCallback,
    pvar_dset_devPSCRegMbboDirect, pvar_dset_devPSCSingleU32MbboDirect,
    ...
    pvar_dset_devPSCBlockOutWf16, pvar_dset_devPSCBlockInWf24,
    pvar_dset_devPSCBlockInWf32, pvar_dset_devPSCBlockOutWf32,
    pvar_dset_devPSCBlockInWfF32, pvar_dset_devPSCBlockOutWfF32,
    pvar_dset_devPSCBlockInWfF64, pvar_dset_devPSCBlockOutWfF64
};
...
epicsShareExtern reg_func pvar_func_PSCRegister, pvar_func_arrInitialize,
    pvar_func_asSub, pvar_func_dbndInitialize, pvar_func_decInitialize,
    pvar_func_rsrvRegistrar, pvar_func_syncInitialize,
    pvar_func_tsInitialize, pvar_func_utagInitialize,
    pvar_func_register_func_ADCsub, pvar_func_register_func_FAsub,
    pvar_func_register_func_LiveSub, pvar_func_register_func_SAsub,
    pvar_func_register_func_TBTsub;
...
int zbpm3_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    runRegistrarOnce(pvar_func_register_func_ADCsub);
    runRegistrarOnce(pvar_func_register_func_FAsub);
    runRegistrarOnce(pvar_func_register_func_LiveSub);
    runRegistrarOnce(pvar_func_register_func_SAsub);
    runRegistrarOnce(pvar_func_register_func_TBTsub);
    iocshRegisterVariable(vardefs);
    return 0;
}

/* zbpm3_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: zbpm3_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(zbpm3_registerRecordDeviceDriver(*iocshPpdbbase));
}
